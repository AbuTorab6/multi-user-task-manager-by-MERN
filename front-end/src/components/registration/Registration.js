...
import { userRegistration } from '../../APIServices/CRUDServices';
...
const Registration = () => 
{
    ...
    var registrationFunc = ()=>
    {
        ...
        {
            userRegistration(firstName,lastName,email,mobile,password,photo).then
            (
                (res)=>
                {
                    if(res===true)
                    {
                        cogoToast.success("User Registration Successfull");
            ...
            <section className='regi-section'>
                <div className='row'>
                    <div className='form'>
                        ...
                        <div>
                            <button onClick={registrationFunc}  className='next-btn'>Next</button>
                        </div>
                    </div>
                </div>
            </section>
